...
def home_page():
    ...
    <p>Access to clean water is a critical challenge in many parts of the world. Water quality prediction is important for ensuring the availability of safe and clean water for 
    ...
    the Megochan has initiated a project to develop an automated water quality prediction system using 
    machine learning.</p> """, unsafe_allow_html=True)

    st.write(f"""<h2>Project goals</h2> <p>In this project, the Megochan water quality assessment primary goal in this project 
...
def about_page():
    st.write("""<h1>MEGOCHAN Water Quality Assessment</h1>""", unsafe_allow_html=True)
    
    st.write("""
        <p>Megochan is a landlocked country located in East Africa, 
